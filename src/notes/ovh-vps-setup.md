---
title: Setting up a VPS on OVH
description: Setting up a secure VPS on OVH
draft: false
tags:
  - vps
  - ssh
  - ovh
createdDate: 2024-10-12T18:03:21-06:00
updatedDate: 2024-12-10T19:32:52-06:00
---
...
To make it just _that_ much easier to work with, I edited my local SSH configuration `~/.ssh/config` to save the server I am working on:
...
```console title="Alacritty" showLineNumbers="false"
Profile: OpenSSH
