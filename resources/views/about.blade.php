...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2">
        <div>
            <img src="{{ asset('assets/img/me-and-mickey.jpg-full.webp') }}" srcset="{{ asset('assets/img/me-and-mickey.jpg-full.webp') }} 3088w, {{ asset('assets/img/me-and-mickey.jpg-half.webp') }} 1544w, {{ asset('assets/img/me-and-mickey.jpg-third.webp') }} 1028w, " class="w-11/12 shadow rounded" alt="">
        </div>
